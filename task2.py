...
from functions import Procesing_Docs, Computing_Weight, find_most_similars_docs, Weight
...
if __name__ == "__main__":
    ...
    docs_indexed, df = Procesing_Docs(docs)
    ...
    print "Printing documents most similars"
    for x in xrange(3):
